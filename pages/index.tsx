...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      <Head>
        <title>SONMAR — Система поддержки решений</title>
        <meta
          name="description"
          content="Платформа SONMAR для регистрации, подтверждения и управления гарантийными талонами и инструкциями по эксплуатации."
        />
      </Head>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { h: "Прозрачный процесс", p: "Отслеживание статуса в реальном времени" },
                    ...
                    <div key={i.h} className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">{i.h}</h3>
